...
export type ChapterAccent = "cobalt" | "marigold";
export type MemberColor = "cobalt" | "poppy" | "marigold" | "sunshine";
...
export const southFloridaChapter: ChapterData = {
  ...
  roster: [
    ...
    { name: "Diego Santos", role: "Outreach Coordinator", initials: "DS", color: "marigold" },
    ...
    { name: "Marcus Green", role: "Music Mentor", initials: "MG", color: "marigold" },
...
export const northFloridaChapter: ChapterData = {
  ...
  roster: [
    { name: "Harper Reed", role: "Chapter Lead", initials: "HR", color: "marigold", bio: "PLACEHOLDER: Harper guides chapter planning and builds connections with local schools and families." },
    ...
    { name: "Mia Davis", role: "Events Coordinator", initials: "MD", color: "marigold", bio: "PLACEHOLDER: Mia organizes exhibitions and gatherings that celebrate the chapter’s artists." },
